...
insert into supply_demand values(1, 1, -20, 6, 200, -5, 0, 0, 200, 10, 2.56, 50, 0, 'News about the pandemic is spreading' );
...
insert into supply_demand values(3, 3, 0, 9, 200, -3.5, 0, 0, 200, 10, 4.53, 50, -5, 'States of emergency have been declared in large cities');
...
insert into supply_demand values(6, 6, 0, 15, 200, -5, 0, 0, 200, 10, 8.25, 50, -20, 'News spreads about shortages, driving price upwards' );
insert into supply_demand values(7, 7, 0, 17, 200, -8, 0, 0, 200, 10, 9.75, 50, -26, 'Almost all stores are out of sanitizer');
insert into supply_demand values(8, 8, 0, 19, 200, -9.6, 0, 0, 200, 10, 11.03, 50, -31, 'Stay at home orders are put in place');
insert into supply_demand values(9, 9, 0, 21, 200, -12.3, 0, 0, 200, 10, 12.25, 50, -39, 'Prices continue to skyrocket' );
insert into supply_demand values(10, 15, 0, 23, 200, -17, 0, 0, 200, 10, 13.75, 50, -45, 'Price gouging begins');
...
insert into supply_demand values(31, 31,    0, 25, 125, 0,  -.25, 0,    200, 9.75,  9.50, 75, -25, 'Suppliers have only fulfilled part of the demand' );
...
insert into supply_demand values(35, 35,    0, 25, 125, 0,  -1.25, 0,   200, 8.75,  6.93, 84, -12, 'Local distilleries enter the market, but there is a lag time before they can start producing' );
insert into supply_demand values(36, 36,    0, 25, 125, 0,  -1.5, 0,    200, 8.5,   6.12, 86, -10, 'Suppliers increase production by almost 50%' );
insert into supply_demand values(37, 37,    0, 25, 125, 0,  -1.75, 0,   200, 8.25,  5.25, 86, -8, 'Price continues to drop as quantity increases' );
insert into supply_demand values(38, 38,    0, 25, 125, 0,  -2, 0,      200, 8,     4.05, 95, -6, 'Markets are stabilizing');
insert into supply_demand values(39, 39,    0, 25, 125, 0,  -2.25, 0,   200, 7.75,  3.46, 105, -3, 'Price has dropped as quantity increases');




insert into supply_demand values(40, 40, 0, 25, 125, 0, 0, -2.5, 200, 7.5, 3.03, 110, 0 , 'Market is finally in equilibrium' );
...
insert into supply_demand values(44, 44, 0, 17, 200, -8, 0, -2.5, 200, 7.5, 2.34, 96, 16, 'Quantity demanded beings to drop' );
insert into supply_demand values(45, 45, 0, 15, 200, -5, 0, -2.5, 200, 7.5, 2.11, 92, 18, 'A surplus occurs in the market' );
insert into supply_demand values(46, 46, 0, 13, 200, -3.6, 0, -2.5, 200, 7.5, 1.95, 88, 20, 'Consumers have stopped buying sanitizer');
insert into supply_demand values(47, 47, 0, 11, 200, -3.3, 0, -2.5, 200, 7.5, 1.65, 86, 24, 'Price drops below equilibrium before the pandemic began' );
...
insert into supply_demand values(55, 55,        0, 5, 200, -5,       -1.25,    0, 200,  8.75,     1.25, 61, 18, 'Quantity decreases');
insert into supply_demand values(56, 56,        0, 5, 200, -5,      -1,       0, 200,   9.02,       1.25, 59, 15, 'Market surplus becomes smaller');
insert into supply_demand values(57, 57,        0, 5, 200, -5,       -.75,     0, 200,  9.25,      1.25, 57, 11, 'Market returns to pre pandemic levels');
insert into supply_demand values(58, 58,        0, 5, 200, -5,       -2.5,     0, 200,  9.52,      1.25, 54, 7, 'Price stabilizes');
insert into supply_demand values(59, 59,        0, 5, 200, -5,       -2.5,     0, 200,  9.75,      1.25, 51, 4, 'Quantity stabilizes');




insert into supply_demand values(60, 60, -20, 6, 200, -5, 0, 0, 200, 10, 2.56, 50, 0, 'Market is in equilibrium');
